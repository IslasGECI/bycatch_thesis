# ==========================================
# Título: Grafica el índice conjunto albatros-palangre (UDOI) por celda de la rejilla KDE
#
# Contexto (Por qué):
# El índice UDOI combina la concentración de albatros (N_IND) con la
# intensidad de pesca de palangre (n_points) en un producto normalizado
...
output_figure_path <- "reports/figures/ud_vms_longline_udoi_map.png"
...
# conjunto albatros-palangre (UDOI) en valores crudos sin transformar
...
# el GeoPackage generado por src/export_ud_vms_longline_udoi.R; contiene
# el producto normalizado de albatros y palangre por celda
...
# entre albatros y palangre que saturarían el mapa sin información
...
plot_udoi_grid <- ggplot() +
  ...
  # por el valor del producto normalizado de albatros y palangre que
  ...
  # celdas donde coinciden albatros y palangre
  ...
  # riesgo conjunto de albatros y palangre en el Pacífico mexicano
  geom_sf(
...
# Exporta el mapa del índice conjunto albatros-palangre por celda de
