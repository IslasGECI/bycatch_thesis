...
# indican zonas con agrupación significativa de tráfico de embarcaciones
# pesqueras. El mapa combinado superpone ambas capas para visualizar la
# congestión de embarcaciones dentro del área de alimentación del albatros.
#
# Descripción (Qué / Cómo):
# Lee los polígonos KBA, las celdas hot spot VMS, la intersección KBA ∩
# hot spot VMS, las AMP, la ZEE y la costa. Filtra el KBA a potentialSite
# = TRUE. Construye un mapa con ggplot2 que superpone las celdas hot spot,
# el relleno púrpura del KBA, el relleno rojo de la intersección, la ZEE,
# las AMP y la costa. Usa el bounding box hardcodeado de la región del
# Pacífico mexicano como extensión.
#
# Entradas:
...
#   las celdas con congestión significativa dentro del KBA
...
# Ruta del GeoPackage con la intersección KBA ∩ hot spot VMS para resaltar
# las celdas con congestión significativa dentro del KBA
input_intersection_path <- "data/processed/kba_vms_hotspot_intersection.gpkg"
...
# de congestión VMS en el Pacífico mexicano
output_figure_path <- "reports/figures/kba_and_vms_hotspot_map.png"
...
# por src/export_kba_vms_hotspot_intersection.R
kba_vms_hotspot_intersection_sf <- st_read(input_intersection_path, quiet = TRUE)
...
plot_kba_hotspot_combined <- ggplot() +
  ...
  labs(
    title = "Potential KBA with VMS Hotspots",
