...
# ==== CONFIGURACIÓN ====
anp_shapefile_path <- "data/external/232_ANP-ITRF08_04072025.shp"  # Ruta al shapefile
anp_figure_path <- "reports/figures/anp.png" # Nombre del archivo con la figura

# ==== IMPORTAR Y PREPARAR DATOS ====
shape_data <- st_read(anp_shapefile_path)
