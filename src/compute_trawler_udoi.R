# ==========================================
# Título: Calcula el índice UDOI de solapamiento albatros-arrastre
#
# Contexto (Por qué):
# La rejilla ud_vms_trawler_udoi.gpkg contiene el producto de
# las masas de probabilidad normalizadas de albatros y arrastre
# por celda. El índice UDOI (Utilization Distribution Overlap
# Index) sintetiza en un solo número el solapamiento entre ambas
# distribuciones dentro de la ZEE del Pacífico mexicano.
#
...
# probabilidad de albatros (N_IND) y arrastre (n_points) por celda
input_gpkg_path <- "data/processed/ud_vms_trawler_udoi.gpkg"
...
output_json_path <- "data/processed/trawler_udoi.json"
...
# Importa la rejilla con el producto normalizado de albatros y
# arrastre desde el GeoPackage generado por export_ud_vms_trawler_udoi.R
...
# valor representa la probabilidad conjunta de albatros y arrastre
# en esa celda dentro de la ZEE del Pacifico mexicano
...
# y arrastre en toda la zona de estudio
