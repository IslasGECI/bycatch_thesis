# ==========================================
# Título: Grafica el conteo de puntos VMS de arrastre por celda
#
# Contexto (Por qué):
# El GeoPackage con los z-scores de Getis-Ord Gi* contiene el conteo
# de puntos VMS de arrastre por celda de la rejilla del KDE individual.
# El conteo abarca varios órdenes de magnitud (1 a 67 mil). Winsorizar
...
# Lee el GeoPackage con el conteo de puntos VMS de arrastre y los
...
# Ruta del GeoPackage con el conteo de puntos VMS de arrastre y los
# z-scores de Getis-Ord Gi* por celda, generado por
# src/compute_vms_by_gear_hotspot.R
input_vms_hotspot_gpkg_path <- "data/processed/vms_trawler_hotspot.gpkg"
...
# VMS de arrastre por celda para el reporte del segundo artículo
output_figure_path <- "reports/figures/vms_trawler_n_points_map.png"

# Nombre de la columna que contiene el conteo de puntos VMS de
# arrastre por celda en el GeoPackage de entrada
n_points_column_name <- "n_points_vms_trawler"
...
color_legend_name <- "Number of VMS trawler points"
...
# Importa la rejilla con el conteo de puntos VMS de arrastre y los
...
# punto VMS de arrastre fue registrado; se omiten las celdas sin
...
# de Baja California donde se concentra el tráfico VMS de arrastre en
...
# por el conteo de puntos VMS de arrastre sobre la costa, la ZEE y
...
plot_vms_n_points <- ggplot() +
  ...
  # zonas de pesca de arrastre en el Pacífico mexicano
  geom_sf(
  ...
  # por el conteo winsorizado de puntos de arrastre con escala lineal
  ...
  # California hasta las latitudes del tráfico VMS de arrastre
  coord_sf(
  ...
  labs(
    title = "Number of VMS trawler points per grid cell",
...
# Exporta el mapa del conteo de puntos VMS de arrastre por celda como
