# ==========================================
# Título: Calcula la intersección entre los polígonos KBA de Guadalupe y las AMP de México
#
# Contexto (Por qué):
...
# qué fracción del KBA de Guadalupe está protegida dentro del sistema de AMP.
#
# Descripción (Qué / Cómo):
# Lee el GeoPackage de polígonos KBA de la colonia de Guadalupe y el GeoPackage
# de Áreas Marinas Protegidas de México. Verifica que ambas capas compartan el
# mismo CRS. Calcula la intersección espacial con st_intersection(). Exporta el
# resultado como GeoPackage para graficarlo en el siguiente paso.
#
# Entradas:
...
# Ruta del GeoPackage con los polígonos KBA de la colonia de Guadalupe
...
# ==== ENTRADAS ====
# Importa los polígonos KBA de la colonia de Guadalupe desde el GeoPackage
...
# en el script de visualización plot_kba_guadalupe_mpa_intersection.R
st_write(
