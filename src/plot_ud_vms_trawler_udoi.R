# ==========================================
# Título: Grafica el índice conjunto albatros-arrastre (UDOI) por celda de la rejilla KDE
#
# Contexto (Por qué):
# El índice UDOI combina la concentración de albatros (N_IND) con la
# intensidad de pesca de arrastre (n_points) en un producto normalizado
# que es alto solo donde ambas variables coinciden. Visualizar este
# índice revela las zonas de riesgo de captura incidental.
#
# Descripción (Qué / Cómo):
# Lee el GeoPackage con el producto normalizado UDOI por celda de la
# rejilla KDE generado por export_ud_vms_trawler_udoi.R. Lee el JSON
...
# - El título incluye el UDOI desde data/processed/trawler_udoi.json
# ==========================================
...
# por export_ud_vms_trawler_udoi.R como medida de riesgo conjunto
input_udoi_gpkg_path <- "data/processed/ud_vms_trawler_udoi.gpkg"
...
input_udoi_json_path <- "data/processed/trawler_udoi.json"
...
output_figure_path <- "reports/figures/ud_vms_trawler_udoi_map.png"
...
# conjunto albatros-arrastre (UDOI) en valores crudos sin transformar
...
# el GeoPackage generado por src/export_ud_vms_trawler_udoi.R; contiene
# el producto normalizado de albatros y arrastre por celda
...
# entre albatros y arrastre que saturarían el mapa sin información
...
udoi_title <- paste0(
  "Albatross-trawler overlap index (UDOI = ", udoi_percentage, "%)"
)
...
plot_udoi_grid <- ggplot() +
  ...
  # por el valor del producto normalizado de albatros y arrastre que
  # indica zonas de riesgo conjunto de captura incidental
  geom_sf(
  ...
  # celdas donde coinciden albatros y arrastre
  ...
  # riesgo conjunto de albatros y arrastre en el Pacífico mexicano
  geom_sf(
...
# Exporta el mapa del índice conjunto albatros-arrastre por celda de
