# ==========================================
# Título: Calcula el índice UDOI de solapamiento albatros-palangre
#
# Contexto (Por qué):
# La rejilla ud_vms_longline_udoi.gpkg contiene el producto de
# las masas de probabilidad normalizadas de albatros y palangre
...
# probabilidad de albatros (N_IND) y palangre (n_points) por celda
input_gpkg_path <- "data/processed/ud_vms_longline_udoi.gpkg"
...
# palangre desde el GeoPackage generado por export_ud_vms_longline_udoi.R
...
# valor representa la probabilidad conjunta de albatros y palangre
...
# y palangre en toda la zona de estudio
