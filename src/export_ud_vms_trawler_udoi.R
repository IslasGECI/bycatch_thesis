# ==========================================
# Título: Calcula el producto normalizado de solapamiento de albatros con presencia de arrastre
#
# Contexto (Por qué):
# Necesitamos una superficie conjunta que combine la concentración de
# albatros (N_IND) con la intensidad de pesca de arrastre (n_points)
...
# Lee el GeoPackage de hot spot de arrastre con la columna de conteo
...
output_gpkg_path <- "data/processed/ud_vms_trawler_udoi.gpkg"
...
n_points_masked <- n_points_vms_trawler_per_cell * is_in_eez_outside_gulf
...
# zona de estudio
n_total_trawler_points <- sum(n_points_masked)
...
# probabilidad que suma 1 dentro de la zona de estudio
normalized_trawler_points <- n_points_masked / n_total_trawler_points
...
udoi_values <- normalized_individuals * normalized_trawler_points
...
# y orden de filas que vms_trawler_grid_sf
