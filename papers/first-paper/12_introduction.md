...
The audience for this paper is conservation scientists, spatial planners, protected-area managers, NGOs, and policy makers [@trilateral2023meeting; @mendez2022population].
...
- Core area / UD — foundational: kernel estimation of the UD [@worton1989kernel]; key: UD for home-range overlap [@fieberg2005quantifying]; recent: 50% UD core areas in track2KBA [@beal2021track2kba].
- Marine protected area — key: low overlap with pelagic seabird distributions [@critchley2018marine]; recent: adaptive priority-area identification [@afan2018adaptive].
- Umbrella species — foundational: tracking criteria for important areas [@lascelles2016applying].
- GPS tracking — foundational: how many tracks are needed [@soanes2013many]; key: marine IBA criteria [@soanes2016defining]; recent: track2KBA [@beal2021track2kba].
